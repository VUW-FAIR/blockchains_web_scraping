...
class cct_forum_scraper(scrapy.Spider):
    name = "cct"
    forum_folder_name = "cryptocurrencytalk"
    start_urls = ['https://cryptocurrencytalk.com/']
    ...
    def parse_page(self, response):
        ...
        title = response.selector.xpath('//*[@id="ipsLayout_mainArea"]/div[2]/div[3]/div/h1/span/span/text()').extract()
